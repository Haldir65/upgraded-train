...
RUN apt update && \ 
    apt install -y sudo ninja-build git unzip build-essential zip unzip checkinstall python3 python3-pip zlib1g-dev wget curl tree coreutils autoconf automake libtool libidn2-0-dev pkg-config cmake
